...
Event.Replay.prototype = {
	 ...
	 replayClickEvent: function () {
	 	...
	 	new Effect.Move($('click'), {duration: 0.3, x:this.mouseX, y:this.mouseY, mode: 'absolute'} );
	 	if (this.href) {
	 ...
	 observe: function() {
		 // observe mousemove
		 this.reset();
		 this.mouseObserver = new Event.DelayedMoveObserver (document, 0.01, this.observeMousemove.bind(this) );
		 // observe click
